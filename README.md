...
- GitHub [GonChen/frps](https://github.com/GonChen/frps)
- Docker [GonChen/frps](https://hub.docker.com/r/GonChen/frps)
...
安装
```shell
wget https://raw.githubusercontent.com/GonChen/frps/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
# 以下为国内镜像
wget https://github.ioiox.com/GonChen/frps/raw/branch/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
...
卸载
```shell
wget https://raw.githubusercontent.com/GonChen/frps/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
# 以下为国内镜像
wget https://github.ioiox.com/GonChen/frps/raw/branch/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
```
...
`REPO=GonChen/frps` 由于 **fork** 到你自己的仓库,需修改`GonChen`为你的 GitHub 账号ID.

#### 执行一键脚本
修改以下脚本链接中的`GonChen`为你的 GitHub 账号 ID 后,执行即可.
```shell
wget https://raw.githubusercontent.com/GonChen/frps/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
#### 卸载脚本
...
```shell
git clone https://github.com/GonChen/frps
# git clone 本仓库
git clone https://github.ioiox.com/GonChen/frps
# 国内镜像
...
- GitHub [GonChen/frps](https://github.com/GonChen/frps)
- Docker Hub [GonChen/frps](https://hub.docker.com/r/GonChen/frps)
